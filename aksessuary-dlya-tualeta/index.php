...
$APPLICATION->SetTitle("Аксессуары для туалета");

if (CModule::IncludeModule("iblock")):
    $section_code = "aksessuary-dlya-tualeta";
    $current_section = [];
        ...
        <div class="wrapper">
            ...
            ?>
                <section class="category_type">
                    ...
                    <a href="<?='/catalog/toilet/'.$current_section['CODE'].'/'?>" class="page_description__link-more">Смотреть всё<span></span></a>
                </section>
            <?}?>
