...
$APPLICATION->SetTitle("Технологии для комфорта");
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_PROPERTY_CODE" => array("SOON", "MINI_IMAGE_1", "MINI_IMAGE_2", ""),
		...
		"LIST_PROPERTY_CODE" => array("", "MINI_IMAGE_1", "MINI_IMAGE_2", ""),
		"MESSAGE_404" => "",
		"META_DESCRIPTION" => "-",
		"META_KEYWORDS" => "-",
		"NEWS_COUNT" => "4",
