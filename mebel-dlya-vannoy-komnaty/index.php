...
$APPLICATION->SetTitle("Мебель для ванной комнаты");

if (CModule::IncludeModule("iblock")):
    $section_code = "mebel-dlya-vannoy-komnaty";
    $current_section = [];
...
?>
    <div class="page_pure_life page_category">
        ...
        <div class="wrapper">
            ...
            <?
            if(!empty($current_section['UF_GALLERY_ELEMENT'])) {

                // echo '<pre>';
                // var_dump($current_section);
                // echo '</pre>';

                $GLOBALS['arrFilterPodborkiBySec' . $current_section['ID']] = [
                    'IBLOCK_ID' => $_ENV['GALLERY_ID'],
                    '=ID' => $current_section['UF_GALLERY_ELEMENT']
                ];
            ...
            ?>
                <section class="category_type">
                    <div class="wrap">
                        <?$APPLICATION->IncludeComponent(
                            ...
                            array(
                                ...
                                "FILTER_NAME" => 'arrFilterPodborkiBySec' . $current_section['ID'],
                    ...
                    <a href="<?='/catalog/bathroom/'.$current_section['CODE'].'/'?>" class="page_description__link-more">Смотреть всё<span></span></a>
                </section>
            <?}?>
