...
// echo "<pre>";
// var_dump(SITE_TEMPLATE_PATH.'/assets/images/no-image.png');
// echo "</pre>";
?>
...
/*
	...
	{
		$priceValue = CCatalogProduct::GetOptimalPrice($actualItem['ID'], 1)['DISCOUNT_PRICE'] ;
		
		if (!empty($priceValue))
		{
			echo '<p class="card_item_price">' . number_format($priceValue, 2, '.', ' ') . ' ₽</p>';
		}
	}
*/	?>
