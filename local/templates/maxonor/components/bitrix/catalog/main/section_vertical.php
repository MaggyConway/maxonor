...
if ($arSection = $rsSections->Fetch()) {
	// echo '<pre>'; var_dump($arSection['ID']); echo '</pre>';
}
?>
...
<div class="catalog_head" data-section-id="<?= $arSection['ID'] ?>">
	...
	<div class="mobile_filter_open_btn">Фильтр</div>

	<div class="mobile_filter_panel--bg"></div>
	<div class="mobile_filter_panel">
		<div class="mobile_filter_panel--head">
			<h2>Фильтр</h2><span class="mobile_filter_panel--close"></span>
		</div>
	</div>
</div>
