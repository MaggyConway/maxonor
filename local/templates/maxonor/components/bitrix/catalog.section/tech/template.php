...
// switch ($url) {
//     case '/catalog/bathroom/smesiteli-dlya-vannoy/':
//         LocalRedirect('/smesiteli-dlya-vannoy/');
//         break;

//     case '/catalog/bathroom/smesiteli-dlya-rakoviny/':
//         LocalRedirect('/smesiteli-dlya-rakoviny/');
//         break;

//     case '/catalog/kitchen/':
//         LocalRedirect('/smesiteli-dlya-kukhni/');
//         break;

//     case '/catalog/bathroom/dushevye-sistemy/':
//         LocalRedirect('/dushevye-sistemy/');
//         break;
...
<div class="catalog-section products_grid" data-entity="<?= $containerName ?>">
...
if ($showLazyLoad) {
?>
    <div class="row bx-<?= $arParams['TEMPLATE_THEME'] ?>" style="display: none;">
